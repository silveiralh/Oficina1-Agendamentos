...
import com.uniagenda.agenda.repository.DiasAtendimentoRepository;
...
/**
 * REST controller for managing {@link com.uniagenda.agenda.domain.DiasAtendimento}.
 */
@RestController
@RequestMapping("/api")
public class DiasAtendimentoResource {
    ...
    public DiasAtendimentoResource(DiasAtendimentoRepository diasAtendimentoRepository) {
    ...
    public ResponseEntity<DiasAtendimento> updateDiasAtendimento(@RequestBody DiasAtendimento diasAtendimento) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, diasAtendimento.getId().toString()))
            .body(result);
    }
