...
export class AgendaAtendimentoServidorService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/agenda-atendimento-servidors';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IAgendaAtendimentoServidor[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
