...
export class AgendaReservaSalaService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/agenda-reserva-salas';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IAgendaReservaSala[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
