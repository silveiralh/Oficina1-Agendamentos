...
export class AgendaServidorService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/agenda-servidors';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IAgendaServidor[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
