...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.uniagenda.agenda.domain.AgendaServidor.class.getName() + ".ids");
            ...
            createCache(cm, com.uniagenda.agenda.domain.AgendaSala.class.getName() + ".ids");
            ...
            createCache(cm, com.uniagenda.agenda.domain.Aluno.class.getName() + ".ids");
            createCache(cm, com.uniagenda.agenda.domain.Servidor.class.getName() + ".ids");
